"""
I will be using LeNet5 neural network architecture wtih Theano.
The "Modified" LeNet5 is a convolutional neural network, good for
classifying images.
...
def evaluate_lenet5(train, test, valid,
    ...
    """ Demonstrates lenet on DogsVsCats dataset
    ...
    downnscale_stream = MinimumImageDimensions(
        train_stream,(64,64),which_sources=('image_features',))
    ...
    #X = T.matrix('image_features')
    #T = T.lmatrix('targets')

    x = T.tensor4('image_features')
    yi = T.imatrix('targets')
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        minibatch_index = 0
        for minibatch in cropped_stream.get_epoch_iterator():
            iter += 1
            minibatch_index += 1
            if iter % 100 == 0:
